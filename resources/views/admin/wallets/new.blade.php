...
<div class="modal-container">
    <form action="{{ route('admin.wallet.store', 0) }}" class="wallet_form" autocomplete="off" method="POST"
        ...
        <div class="py-2">
            ...
            <img src="" alt="former_logo" id="former_logo" class="w-20 h-20 mx-auto rounded-full hidden">
    ...
    <script>
        ...
        function showNewForm(data = null) {
            if (data == null) {
                ...
                if (data.logo != null || data.logo != "") {
                    ...
                    modalForm.querySelector("input[name='logo']").style.display = "none";
                }
        ...
        function closeModal() {
            ...
            setTimeout(() => {
                ...
                modalForm.querySelector("input[name='logo']").style.display = "flex";
